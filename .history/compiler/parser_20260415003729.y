...
%type <nval> program statement_list statement var_decl declarator_list declarator assignment if_stmt while_stmt print_stmt func_decl return_stmt for_stmt update expression term unary factor block params args func_call cout_stmt cout_expr_list
